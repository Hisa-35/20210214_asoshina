...
<div id="app">
  ...
  <div class="mission">
        ...
        <div class="mission-img">
          <img src="./components/mission-img.jpg" alt="" />
        </div>
      </div>
      <div class="service">
        ...
        <div class="service-content">
          <div class="service-img">
            <img src="./components/service2.jpg" alt="" />
          </div>
        ...
        <div class="service-content">
          <div class="service-img service-img_second">
            <img src="./components/service1.jpg" alt="" />
          </div>
...
.company-img {
  background: url(../src/components/company.jpeg) center/cover no-repeat;
}

.recruit-img {
  background: url(../src/components/recruit.jpg) center/cover no-repeat;
}
...
/*------------------------*/
.contact {
  background: url(../src/components/contact-bg.jpg) center/cover no-repeat;
  padding: 10%;
}
